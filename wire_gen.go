...
func InitializeServer() (Server, error) {
	...
	frontendRouter := frontend.NewFrontendRouter(logger, appConfig, env, userService, emailService)
	mainRouter := routers.NewMainRouter(logger, apiv1Router, frontendRouter)
